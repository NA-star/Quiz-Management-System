...
<html>
	<head>
		...
		<title>Login | JavaScript Quiz Game</title>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
						<center> <h5 style="font-family: Noto Sans;">Login to </h5><h4 style="font-family: Noto Sans;">JavaScript Quiz Game</h4></center><br>
